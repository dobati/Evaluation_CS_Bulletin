...
PDFJS.imageResourcesPath = './images/';
  PDFJS.workerSrc = "../../Logic/PrettyPrinter/Web/js/pdf.js/build/pdf.worker.js";
    ...
    scrollPageIntoView: function PDFViewer_scrollPageIntoView(pageNumber,
      ...
      switch (dest[1].name) {
        ...
        case 'FitR':
          ...
          widthScale = (viewerContainer.clientWidth - SCROLLBAR_PADDING) / width / CSS_UNITS;
          heightScale = (viewerContainer.clientHeight - SCROLLBAR_PADDING) / height / CSS_UNITS;
...
window.addEventListener('change', function webViewerChange(evt) {
    return; // Till: Disable input file change handler
